...
public class DataDao {
	...
	public void write(Data data,String filename,Encrypter.TYPE type,Alphabet alphabet) throws Exception{
		Encrypter encrypter = new Encrypter();
		if(type.equals(Encrypter.TYPE.FASTRANDOM)) {
			data = encrypter.fastRandomEncrypt(data, alphabet);
		}else if(type.equals(Encrypter.TYPE.FASTLINEAR)) {
		...
		Files.write(Paths.get(filename),data.getEncrypted().getBytes());
	}
